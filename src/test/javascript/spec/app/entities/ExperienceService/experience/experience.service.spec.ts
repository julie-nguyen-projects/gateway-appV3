...
import { IExperience, Experience, Type } from 'app/shared/model/ExperienceService/experience.model';
...
describe('Service Tests', () => {
    describe('Experience Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Experience('ID', 'AAAAAAA', currentDate, currentDate, Type.JOB);
        });
        ...
        describe('Service methods', async () => {
            it('should find an element', async () => {
                const returnedFromService = Object.assign(
                    {
                        beginningDate: currentDate.format(DATE_FORMAT),
